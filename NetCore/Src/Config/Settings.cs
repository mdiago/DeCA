	...
	public class Settings
	{
        ...
        internal static Settings GetDefault() 
        {
            ...
            return new Settings()
            {
                ...
                CertificatePassword = "",
                LoggingEnabled = true,
                DECaSettings = new DECaSettings() 
                {
                    DECaEndPointPrefix = DECaEndPointPrefixes.Test,
                },
                Api = new Api()
                {
        ...
        /// <summary>
        /// Datos del API REST para DECa de Irene Solutions.
        /// </summary>
        [XmlElement("Api")]
