...
namespace DECa.Qrcode
{
    ...
    internal sealed class Mode 
    {
        ...
        // Not really a mode...
        public static readonly Mode TERMINATOR = new Mode(new int[] { 
            0, 0, 0 }, 0x00, "TERMINATOR");

        public static readonly Mode NUMERIC = new Mode(new int[] { 10, 
            12, 14 }, 0x01, "NUMERIC");
        ...
        // Not supported
        public static readonly Mode STRUCTURED_APPEND = new Mode(new int
            [] { 0, 0, 0 }, 0x03, "STRUCTURED_APPEND");

        public static readonly Mode BYTE = new Mode(new int[] { 8, 16, 
            16 }, 0x04, "BYTE");

        // character counts don't apply
        public static readonly Mode ECI = new Mode(null, 0x07, "ECI");

        public static readonly Mode KANJI = new Mode(new int[] { 8, 10
            , 12 }, 0x08, "KANJI");

        public static readonly Mode FNC1_FIRST_POSITION = new Mode(null
            , 0x05, "FNC1_FIRST_POSITION");

        public static readonly Mode FNC1_SECOND_POSITION = new Mode(null
